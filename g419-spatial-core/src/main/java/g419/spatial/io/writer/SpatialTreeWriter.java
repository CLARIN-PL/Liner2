...
import g419.spatial.formatter.SpatialExpressionFormatterTree;
...
public class SpatialTreeWriter extends AbstractDocumentWriter {
  ...
  final ISpatialExpressionFormatter formatter = new SpatialExpressionFormatterTree();

  public SpatialTreeWriter(final OutputStream os) {
